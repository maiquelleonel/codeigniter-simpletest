...
define('SIMPLETEST', MAIN_PATH .'simpletest/lib/'); // Directory of simpletest
...
define('TESTS_DIR', APP_DIR . 'tests/'); // Directory of your tests.
...
class CodeIgniterUnitTestCase extends UnitTestCase {
	...
	public function __construct(){
      ...
      $this->_ci->load->database('developing',true);
	}
...
if ($cli_mode) {
    ...
    include(ROOT . 'simpletest/test_gui.php');
}
